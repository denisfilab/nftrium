...
from main.views import delete_nft_entry, edit_nft_entry, logout_user, show_main, create_nft_entry, nft_detail, show_xml, show_json, show_xml_by_token_id, show_json_by_token_id, register, login_user, view_json_ui, view_xml_ui
